...
config_con_cli=aws_mag_con.client(service_name="config",region_name="us-east-1")
sns_list_subs_by_topic_con_cli=aws_mag_con.client(service_name="config",region_name="us-east-1")
...
'''	
#List all ConfigRules 
response=config_con_cli.describe_config_rules()
for each_item in response['ConfigRules']:
	print(each_item['ConfigRuleName'])
'''
